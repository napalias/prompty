...
enum Strings {
    ...
    enum Accessibility {
        static let panelLabel = "Prompty floating panel"
    ...
    enum Settings {
        ...
        static let hotkeyDefault = "Control+Shift+L"
        ...
        static let launchAtLoginDescription = "Automatically start Prompty when you log in."
    ...
    enum MenuBar {
        ...
        static let hotkeyHint = "Hotkey: Control+Shift+L"
    }
    ...
    enum Onboarding {
        static let welcomeTitle = "Welcome to Prompty"
        ...
        static let accessibilityDescription = "Prompty needs Accessibility access to read selected text from other apps."
        static let inputMonitoringTitle = "Input Monitoring"
        static let inputMonitoringDescription = "Prompty needs Input Monitoring access to detect your global hotkey."
        ...
        static let readyDescription = "Press Control+Shift+L on any selected text to get started. You can change the hotkey in Settings."
        static let getStarted = "Get Started"
    }

    enum SingleInstance {
        static let alreadyRunning = "Prompty is already running"
