...
/// Exhaustive error type for AITextTool. No stringly-typed errors.
enum AppError: LocalizedError, Equatable {
    ...
    var recoverySuggestion: String? {
        switch self {
        case .accessibilityPermissionDenied:
            return "Open System Settings > Privacy > Accessibility and enable AITextTool."
        case .inputMonitoringPermissionDenied:
            return "Open System Settings > Privacy > Input Monitoring and enable AITextTool."
        case .noTextSelected:
